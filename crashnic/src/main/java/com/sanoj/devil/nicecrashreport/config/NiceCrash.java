 ...
 */
public class NiceCrash implements Serializable {
    ...
    public static class Builder {
        private NiceCrash config;

        @NonNull
        public static Builder create() {
            Builder builder = new Builder();
            NiceCrash currentConfig = CrashActivity.getConfig();

            NiceCrash config = new NiceCrash();
